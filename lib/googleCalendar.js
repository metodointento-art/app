...
// Lista TODOS eventos no período + filtra em JS por extendedProperties.shared['goo.createdBySet']='default_cita'.
// (O filtro via sharedExtendedProperty na API não funciona com nomes que têm ponto.)
export async function listarBookingsAppointment(vendedorEmail, timeMinISO, timeMaxISO) {
  ...
  return items.filter((e) =>
    e.extendedProperties?.shared?.[APPT_SCHEDULE_TAG_KEY] === APPT_SCHEDULE_TAG_VAL
  );
}
